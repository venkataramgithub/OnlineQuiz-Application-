<?php
	...
	$sql=mysqli_query($conn,"select * from quizquestion where sl='$quizid'");
...
<head>
	...
	<script type="text/javascript">
		function messagehide() {
			...
			location.href="managequizquestion.php";
		}
	</script>
</head>
<body>
	<?php
		if(isset($_POST['submit'])){
			...
			$sql=mysqli_query($conn,"update quizquestion set quizname='$quizname',question='$question',option1='$option1',option2='$option2',option3='$option3',option4='$option4' where sl='$quizid'");
			if(!$sql){
				echo '<div class="message" id="message">Question not updated<span onclick="messagehide()">&times;</span></div>';
			}
			else{
				echo '<div class="message" id="message">Question updated successfully<span onclick="messagehide()">&times;</span></div>';
			}
		}
	?>
		...
		<div class="teachers-box">
			...
			<form method="post" action="" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="text" name="question" <?php echo 'value="'.$fetch['question'].'"';?> required>
				</div>
				<div class="form-group1">
					<label>Option1:</label>
					<input type="text" name="option1" <?php echo 'value="'.$fetch['option1'].'"';?> required>
					<label>Option2:</label>
					<input type="text" name="option2" <?php echo 'value="'.$fetch['option2'].'"';?> required>
				</div>
				<div class="form-group1">
					<label>Option3:</label>
					<input type="text" name="option3" <?php echo 'value="'.$fetch['option3'].'"';?> required>
					<label>Option4:</label>
					<input type="text" name="option4" <?php echo 'value="'.$fetch['option4'].'"';?> required>
				</div>
